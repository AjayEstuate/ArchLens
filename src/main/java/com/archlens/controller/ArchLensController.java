...
public class ArchLensController {
	...
	@GetMapping(value = "/view/ds={config}/schema={schema}/tablename={table}/blobColName={blobColName}/fileName={fileName}/{idName}={idVal}", produces = MediaType.ALL_VALUE)
	public ResponseEntity<?> viewBlob(@PathVariable String config, @PathVariable String schema,
	...
	@GetMapping(value = "/download/ds={config}/schema={schema}/tablename={table}/blobColName={blobColName}/fileName={file_name}/{idName}={idVal}", produces = MediaType.ALL_VALUE)
	public void downloadFile(@PathVariable String config, @PathVariable String schema, @PathVariable String table,
		...
		List result = ExternalTableConfig.createConnection(config, schema, table, blobColName, file_name, idName,idVal);
